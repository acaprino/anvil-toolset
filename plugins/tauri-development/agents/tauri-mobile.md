...
name: tauri-mobile
description: >
  Expert in Tauri 2 mobile development for Android and iOS. Use proactively when working
  with mobile environment setup (Android SDK, Xcode, NDK), emulator/ADB testing, mobile
  plugins (biometric, haptics, barcode, NFC, geolocation, notifications), in-app purchases,
  mobile OAuth deep links, code signing for Play Store/App Store, and mobile CI/CD pipelines.
model: opus
color: green
---
