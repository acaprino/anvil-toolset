...
The CSS patterns above show modern responsive techniques (container queries, fluid type, anchored positioning). The rules below cover the strategy layer: mobile-first thinking, breakpoint discipline, input-method detection, and responsive imagery.
