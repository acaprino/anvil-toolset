...
The tactical selection procedure and the reflex-reject list live in the `frontend-strategy` skill, under `references/brand-register.md` (sections **Font selection procedure** and **Reflex-reject list**). The rest of this section covers the adjacent knowledge: anti-reflex corrections, system font use, and pairing rules.
