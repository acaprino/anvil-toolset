...
Source: .claude/skills/design-system/references/component-tokens.md
Snapshot 2026-05-11.
-->

# Component Tokens

Component-specific tokens that reference the semantic layer. The outermost layer of the three-layer token system.
