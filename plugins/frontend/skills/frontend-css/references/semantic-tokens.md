<!--
Portions of this file are derived from nextlevelbuilder/ui-ux-pro-max-skill
(https://github.com/nextlevelbuilder/ui-ux-pro-max-skill), MIT License.
Source: .claude/skills/design-system/references/semantic-tokens.md
Snapshot 2026-05-11.
-->

# Semantic Tokens

Purpose-based aliases that reference primitive tokens. The middle layer between raw values and component-specific tokens.
