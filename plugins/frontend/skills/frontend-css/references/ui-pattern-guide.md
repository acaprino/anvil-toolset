...
# Interaction Design (States & Behaviors)

The patterns above describe WHICH component to use; the rules below describe HOW interactive elements should behave in every state.
