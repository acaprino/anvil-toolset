...
description: >
  ...
  DO NOT TRIGGER WHEN: the task is purely backend or unrelated to web frontend.
---
...
0. BEST: Fetch https://web-platform-dx.github.io/web-features-explorer/groups/ and find the feature in there, then fetch its detail page.
