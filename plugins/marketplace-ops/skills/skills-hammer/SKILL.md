...
name: skills-hammer
description: >
  Guided creation of anvil-toolset components -- skills, agents, commands, and
  full plugins. Walks through requirements gathering, generates production-ready
  files with real content (not placeholders), registers in marketplace.json, and
