...
**The terminal state is invoking writing-plans.** Do NOT invoke any implementation skill (frontend, python-tdd, tauri, etc.) directly. The ONLY skill you invoke after brainstorming is writing-plans.
