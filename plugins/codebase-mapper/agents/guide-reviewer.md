...
name: guide-reviewer
description: >
  Phase 3 of codebase-mapper. Reviews all 8 generated documents for consistency, adds
  cross-references, uniformizes tone, and produces INDEX.md. Flags gaps and contradictions.
